...
const Pool = ({setLoading,connectContract}) => {
    ...
    const handleSubmit = async(e)=>{
        e.preventDefault();
        const addToken = await connectContract.pool(token1,token2);
    ...
    return (
        ...
        <h1 className="text-yellow-400 text-3xl flex justify-center mt-4">Pool</h1>
       ...
       <div className="flex flex-row justify-center mt-20">
        ...
        rounded " onClick={handleSubmit}>Pool</button>
